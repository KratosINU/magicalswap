        ...
        477: function(e, n, t) {
            ...
            var Xl = {
                ...
                ld = [{
                    label: "Home",
                    icon: "HomeIcon",
                    href: "https://www.magicalgrowbsc.space/"
                }, {
                    label: "Trade",
                    icon: "TradeIcon",
                    initialOpenState: !0,
                    ...
                    items: [{
                        label: "Twitter",
                        href: "https://twitter.com/magicalgrowbsc"
                    }, {
                        label: "Telegram",
                        href: "https://t.me/MagicalGrow"
                    },{
                        label: "Medium",
                        href: "https://medium.com/@magicalgrow"
                    },{
                        label: "Github",
                        href: "https://github.com/MagicalGrow"
                    }]
                }],
                dd = function(e) {
                    var n = Object(g.c)(),
